...
public class Memory {
    ...
    public double getFloat(int address) {
        long bits  =  (((long)getByte(address))  << 40) | (((long)getByte(address+1) << 32) & (Long.valueOf("0XFFFFFFFFFF",16).longValue())) |
                      (((long)getByte(address+2) << 24) & (Long.valueOf("0XFFFFFFFF",16).longValue())) | (((long)getByte(address+3) << 16) & (Long.valueOf("0XFFFFFF", 16).longValue())) |
                      (((long)getByte(address+4) << 8) & (Long.valueOf("0XFFFF", 16).longValue()))  | (((long)getByte(address+5)) & (Long.valueOf("0XFF", 16).longValue()));
