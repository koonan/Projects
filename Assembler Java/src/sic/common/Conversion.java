...
public class Conversion {
    ...
    public static String dataToWord(byte[] data) {
        ...
        while (i < data.length - 2) {
            int num = (((int)data[i]) << 16) | ((((int)data[i+1]) << 8) & 0XFFFF) | (data[i+2] & 0XFF);
    ...
    public static String dataToFloat(byte[] data) {
        ...
        while (i < data.length - 5) {
            long num = (((long)data[i]) << 40) | ((((long)data[i+1]) << 32) & (Long.valueOf("0XFFFFFFFFFF",16).longValue())) | ((((long)data[i+2]) << 24) & (Long.valueOf("0XFFFFFFFF",16).longValue())) |
                      ((((long)data[i+3]) << 16) & (Long.valueOf("0XFFFFFF",16).longValue())) | ((((long)data[i+4]) << 8) & (Long.valueOf("0XFFFF",16).longValue())) | (data[i+5] & Long.valueOf("0XFF",16).longValue());
